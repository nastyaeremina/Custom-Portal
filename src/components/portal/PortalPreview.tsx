          ...
          <TabsContent value="raw" className="h-full">
            <div className="p-4 bg-white rounded-xl h-full flex flex-col">
              ...
              <div className="flex gap-4 flex-1 min-h-0">
                {/* Left column - Structured Outputs */}
                <div className="flex-1">
                  <h3 className="text-xs font-medium text-neutral-500 uppercase tracking-wide mb-2">Structured Outputs</h3>
                    ...
                    <div>
                      ...
                      <div className="grid grid-cols-4 gap-2">
                        ...
                        <div>
                          ...
                          <p className="text-[9px] text-neutral-400">1160×1160{rawOutputs?.generatedWithDalle ? " (DALL-E)" : ""}</p>
                        </div>
                        {/* Social Image */}
                        <div>
                          <div className="w-full aspect-square bg-neutral-100 rounded border border-neutral-200 overflow-hidden mb-1 flex items-center justify-center">
                ...
                {rawOutputs && (
                  <div className="w-48 border-l border-neutral-100 pl-4">
                    <h3 className="text-xs font-medium text-neutral-500 uppercase tracking-wide mb-2">Debug Data</h3>
                    <div className="space-y-2.5 text-[10px]">
                      <div>
                        <p className="text-neutral-500 mb-1">Scraped Colors ({rawOutputs.scrapedColors.length})</p>
                        <div className="flex flex-wrap gap-0.5">
                          {rawOutputs.scrapedColors.slice(0, 12).map((color, i) => (
                            <div
                              key={i}
                          ...
                          {rawOutputs.scrapedColors.length > 12 && (
                            <span className="text-neutral-400 text-[10px] self-center ml-0.5">+{rawOutputs.scrapedColors.length - 12}</span>
                          )}
                        </div>
                      </div>
                      <div>
                      ...
                      <div className="space-y-0.5 text-neutral-600">
                        ...
                        <p>DALL-E Used: {rawOutputs.generatedWithDalle ? "Yes" : "No"}</p>
                      </div>
                    </div>
                  </div>
                )}
